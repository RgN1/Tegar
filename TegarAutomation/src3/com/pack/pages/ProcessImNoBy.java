...
public class ProcessImNoBy {
	...
	public  ProcessImNoBy(WebDriver driver) {
...
epiredate.click();
	...
	try{
		driver.findElement(By.xpath("//div[text()='0.1']"));
		
	driver.findElement(By.xpath("//div[text()='Draft']"));
	}catch(Exception nosuchException){System.out.println("no element draft");}
